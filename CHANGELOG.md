...
### Updated
- **Base Image**: Updated to LinuxServer NZBGet v26.1-ls244 (from v26.1-ls238). Picks up upstream baselayer rebuilds; no NZBGet version change.
...
### Updated
- **Base Image**: Updated to LinuxServer NZBGet v26.0-ls231 (from v25.4-ls225)

### Upstream Changes (NZBGet v26.0)
- Major NZBGet version bump from v25.4 to v26.0
