...
# Base image: NZBGet v26.0 (LinuxServer build ls235)
FROM ghcr.io/linuxserver/nzbget:v26.0-ls235
...
LABEL org.opencontainers.image.title="nzbgetvpn" \
      ...
      org.opencontainers.image.base.name="ghcr.io/linuxserver/nzbget:v26.0-ls234"
