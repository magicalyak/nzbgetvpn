...
# Base image: NZBGet v25.4 (LinuxServer build ls221)
FROM ghcr.io/linuxserver/nzbget:v25.4-ls221
...
LABEL org.opencontainers.image.title="nzbgetvpn" \
      ...
      org.opencontainers.image.base.name="ghcr.io/linuxserver/nzbget:v25.4-ls221"
